...
extension UdacityDBClient {
    ...
    struct Constants {
        ...
        static let urlHeader                : String = "http://"
        ...
        static let msgEnterName             : String = "Provide your first and last name"
        static let msgEnterPlaceOfStudy     : String = "Provide your today's place of study"
